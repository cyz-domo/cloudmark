...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    /** When true, no dimmed backdrop (e.g. nested emoji picker) */
    hideOverlay?: boolean;
    /** Hide the top-right close button */
    hideClose?: boolean;
  }
>(({ className, children, hideOverlay, hideClose, ...props }, ref) => (
  <DialogPortal>
    {hideOverlay ? (
      // Invisible overlay still receives outside clicks to dismiss
